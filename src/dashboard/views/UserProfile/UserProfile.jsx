...
// utils
import CheckCommon from "../../utils/CheckCommon.jsx";
// core components
...
class UserProfile extends React.Component{
  ...
  change(event, stateName, type, stateNameEqualTo, maxValue) {
    switch (type) {
      case "email":
        if (CheckCommon.isEmail(event.target.value)) {
        ...
        break;
      case "password":
        if (CheckCommon.isLength(event.target.value, 1)) {
          this.setState({ [stateName + "State"]: "success" });
        } else {
          this.setState({ [stateName + "State"]: "error" });
        }
      ...
      case "checkbox":
        ...
        break;
      case "number":
        if (CheckCommon.isNumber(event.target.value)) {
          this.setState({ [stateName + "State"]: "success" });
        } else {
          this.setState({ [stateName + "State"]: "error" });
        }
        break;
      case "length":
        if (CheckCommon.isLength(event.target.value, stateNameEqualTo)) {
          this.setState({ [stateName + "State"]: "success" });
        } else {
          this.setState({ [stateName + "State"]: "error" });
        }
        break;
      case "max-length":
        if (!CheckCommon.isLength(event.target.value, stateNameEqualTo + 1)) {
          this.setState({ [stateName + "State"]: "success" });
        } else {
          this.setState({ [stateName + "State"]: "error" });
        }
        break;
      case "url":
        if (CheckCommon.isUrl(event.target.value)) {
          this.setState({ [stateName + "State"]: "success" });
        } else {
          this.setState({ [stateName + "State"]: "error" });
        }
      ...
      case "min-value":
        if (
          CheckCommon.isNumber(event.target.value) &&
